...
export const articles: Article[] = [
  {
    ...
    content: `
      ...
      <h3>Le serment à l'ère moderne</h3>
  ...
  },
  {
    ...
    description: 'Stratégies pratiques pour maintenir son équilibre mental pendant les études médicales',
    content: `
      ...
      <h3>Comprendre la source du stress</h3>
      ...
      <h3>Stratégies de gestion au quotidien</h3>
      <ul>
      ...
      <h3>Se projeter positivement</h3>
  ...
  },
  {
    ...
    description: 'Comment le repos nocturne optimise la mémorisation et la compréhension',
    content: `
      ...
      <h3>Les neurosciences du sommeil et de la mémoire</h3>
      ...
      <h3>Le mythe du "bourrage de crâne"</h3>
      ...
      <h3>Optimiser son sommeil pour mieux apprendre</h3>
      <ul>
      ...
      <h3>Le sommeil et la performance clinique</h3>
      ...
      <h3>Stratégies pratiques pour l'étudiant en médecine</h3>
  ...
  },
  {
    ...
    description: 'Développer des compétences relationnelles essentielles pour la pratique clinique',
    content: `
      ...
      <h3>Pourquoi la communication médicale est essentielle</h3>
      ...
      <h3>Les piliers de la communication médicale</h3>
      <ul>
      ...
      <h3>La consultation médicale modèle</h3>
      ...
      <h3>Gérer les situations difficiles</h3>
      ...
      <h3>Communication et éthique</h3>
      ...
      <h3>Développer ses compétences</h3>
  ...
  },
  {
    ...
    description: 'Comprendre et appliquer l\'EBM pour une pratique clinique optimale',
    content: `
      ...
      <h3>Qu'est-ce que la Médecine Basée sur les Preuves?</h3>
      ...
      <h3>Les cinq étapes de l'EBM</h3>
      ...
      <h3>Lire un article médicalement</h3>
      ...
      <h3>EBM et pratique clinique quotidienne</h3>
  ...
  },
  {
    ...
    description: 'Comment l\'IA transforme la pratique médicale et ce que les futurs médecins doivent savoir',
    content: `
      ...
      <h3>Les applications actuelles de l'IA en médecine</h3>
      ...
      <h3>L'IA et le futur diagnostic</h3>
      ...
      <h3>Les limites et risques éthiques</h3>
      ...
      <h3>L'IA et la relation médecin-patient</h3>
      ...
      <h3>Se préparer à la médecine augmentée</h3>
      ...
      <h3>L'apprentissage médical transformé</h3>
  ...
  },
  {
    ...
    title: 'L\'Interprofessionnalité en Santé : Collaborer pour de Meilleurs Soins',
    description: 'Pourquoi le travail en équipe pluridisciplinaire est essentiel à la pratique médicale moderne',
    content: `
      ...
      <h3>Qu'est-ce que la pratique interprofessionnelle?</h3>
      ...
      <h3>Les bénéfices de la collaboration interprofessionnelle</h3>
      <ul>
      ...
      <h3>Comprendre les rôles de chaque professionnel</h3>
      ...
      <h3>Communication au sein de l'équipe</h3>
      ...
      <h3>Formation interprofessionnelle</h3>
      ...
      <h3>Le patient comme membre de l'équipe</h3>
      ...
      <h3>Développer ses compétences collaboratives</h3>
